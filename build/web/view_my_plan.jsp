...
<html>
    <head>
        ...
        <title> Royal World - My Plan </title>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="row" style="border: 1px solid #ff66ff; box-shadow: 2px 2px 2px #ff00ff; border-radius: 10px;">
                                <div class="col-md-12">
                                    <strong  style="font-size: 35px; color: #ff0000;"> <center> © My Current Plan © </center> </strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1">
                ...
                <jsp:scriptlet>
                    ...
                    try {
                        ...
                        ps1 = con.prepareStatement("SELECT * FROM user_request_for_plan_details , our_plans WHERE user_email=? AND user_request_for_plan_details.plan_no = our_plans.plan_no");
                        ...
                        if (rs1.next()) {
                            ...
                            buy_plan_date2 = rs1.getString("date1");
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <center>
                                                ...
                                                <strong style="float: right; color: #ff0000;"> Date of Buy This Plan : <jsp:expression>buy_plan_date2</jsp:expression> </strong>
                                        </div> <hr>
                                        <div class="row">
                                            <div class="col-md-1">
